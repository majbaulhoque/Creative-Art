          ...
          <div className="row align-items-center gx-lg-5">
            ...
            <div className="col-12 col-md-7 order-2 order-sm-1">
              <h2 className="fw-bolder mb-4 text-center text-md-start">
                CAD Visual Art Classes
              </h2>
              <p className="common-description mb-4">
                In our comprehensive Visual Art classes, students embark on a
                journey to explore the rich world of art, culture, and
                creativity. Our expert instructors guide students through a
                structured curriculum that covers:
              </p>
              ...
              <ul className="list-unstyled visual-ul">
                <li className="mb-2 visual-li">
                  ...
                  Exploring famous artists, movements, and styles
                  (Impressionism, Modernism, Pop Art, etc.)
                </li>
              </ul>
              <p className="common-description mb-4 fw-bolder">
              ...
              <ul className="list-unstyled visual-ul">
                <li className="mb-2 visual-li">
                  <FaPalette
                    ...
                    style={{ color: "#FF6347" }}
                  />
                  Mastering methods inspired by Van Gogh, Hokusai, Georgia O
                  {`'`}Keeffe, and more
                </li>
                <li className="mb-2 visual-li">
                  <FaBookOpen
                    ...
                    style={{ color: "#1E90FF" }}
                  />
                  Learning perspective, proportions, composition, color mixing,
                  and form
                </li>
              </ul>
              <p className="common-description mb-4 fw-bolder">
                Paper Craft and 3D Art:
              </p>
              <ul className="list-unstyled visual-ul">
                <li className="mb-2 visual-li">
                  <FaCube className="mr-2 me-2" style={{ color: "#FF4500" }} />
                  Creating 3D Pop-up books and paper sculptures inspired by Van
                  Gogh and Vasarely
                </li>
                <li className="mb-2 visual-li">
                  <FaPaintBrush
              ...
              <ul className="list-unstyled visual-ul">
                <li className="mb-2 visual-li">
                  <FaTabletAlt
                    ...
                    style={{ color: "#FF4500" }}
                  />
                  Bringing paper craft to life through digital tools and
                  techniques
                  <br />
                  <FaChalkboardTeacher
                    className="mr-2 me-2"
                    style={{ color: "#1E90FF" }}
                  />
                  Through project-based learning, students develop critical
                  thinking, creativity, and cultural awareness. Our classes
                  foster a deep appreciation for art, enabling students to
                  analyze, interpret, and create meaningful works of art.
                </li>
              </ul>
            </div>
          </div>
