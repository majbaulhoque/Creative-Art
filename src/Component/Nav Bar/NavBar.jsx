                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            <Nav className="me-auto fw-bolder text-dark">
                                ...
                                >
                                    ...
                                    <NavDropdown.Item as={Link} to="/whyUs">
                                        Why Us
                                    </NavDropdown.Item>
                                ...
                                <NavDropdown
                                    ...
                                    title={
                                        <NavLink
                                            to="/classes"
                                            className="text-dark custom-nav-dropdown text-decoration-none"
                                            end
                                        >
                                            Classes
                                        </NavLink>
                                    ...
                                    onMouseLeave={handleMouseLeave}
                                >
                                    <NavDropdown.Item as={Link} to="/aboutOurClasses">
                                        About Our Classes
                                    </NavDropdown.Item>
                                    <NavDropdown.Item as={Link} to="/fineArt">
                                        Fine Art
                                    </NavDropdown.Item>
                                    <NavDropdown.Item as={Link} to="/visualArt">
                                        Visual Art
                                    </NavDropdown.Item>
                                    <NavDropdown.Item as={Link} to="/social-presentation">
                                        Social Presentation
                                    </NavDropdown.Item>
                                    <NavDropdown.Item as={Link} to="/digital-art">
                                        Digital Art
                                    </NavDropdown.Item>
                                    <NavDropdown.Item as={Link} to="/adults-development">
                                        Art for Special Needs
                                    </NavDropdown.Item>
                                    <NavDropdown.Item as={Link} to="/art-for-senior">
                                        Art For Senior
                                    </NavDropdown.Item>
                                    <NavDropdown.Item as={Link} to="/fashion-design">
                                ...
                                <Nav.Link
                                    href="https://www.instagram.com/creativeartanddesigninc"
                                    target="_blank"
