          ...
          <section>
            <div className="row">
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3 ">
                ...
                <div className=''>
                  <a href='https://www.instagram.com/creativeartanddesigninc' className='text-decoration-none text-white d-flex gap-2'>
                    <span><FaInstagram className="mr-3" /></span>
                    Instagram</a>
                </div>
                <br />
                <p className='text-white'>
                  <a href="mailto:info@creativeartanddesigninc.com" className="text-decoration-none text-white d-flex gap-2">
          ...
          <section className="p-3 pt-0">
            <div className="row d-flex align-items-center">
              <div className="col-md-7 col-lg-8 text-center text-md-start">
                <div className="p-3">
                  © 2024 Copyright:
                  <Link className="text-white text-decoration-none" to="/"> Creative Art & Design</Link>
                </div>
              </div>
              ...
              <div className="col-md-5 col-lg-4 ml-lg-0 text-center text-md-end">
                ...
                <a className="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/creativeartanddesigninc" role="button">
                  <FaInstagram />
                </a>
              </div>
            </div>
